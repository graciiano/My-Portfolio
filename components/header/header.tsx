...
export default function Header() {
    ...
    return (
        <header className="w-full h-[64px] fixed top-0 left-0 bg-backgroundPage/95 backdrop-blur-sm z-50 border-b border-textSecondary/10">
            <div className="flex container  mx-auto px-4 sm:px-6 lg:px-8 h-full items-center justify-between">
                ...
                <nav className="hidden sm:flex gap-8">
                    <Link
                        ...
                        className={`relative text-lg text-textPrimary hover:text-textSecondary transition-colors duration-300 ${
                            isActive('/') 
                            ? 'font-semibold after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px] after:bg-textSecondary after:animate-underline'
                            : 'hover:after:absolute hover:after:bottom-0 hover:after:left-0 hover:after:w-full hover:after:h-[2px] hover:after:bg-textSecondary/30 hover:after:animate-underline'
                        }`}
                    >
                        Sobre
                    </Link>
                ...
                <div className="sm:hidden">
                    <Sheet>
                        ...
                        <SheetContent 
                            side="right" 
                            className="w-[280px] bg-backgroundPage/95 backdrop-blur-sm border-l border-textSecondary/10"
                        >
